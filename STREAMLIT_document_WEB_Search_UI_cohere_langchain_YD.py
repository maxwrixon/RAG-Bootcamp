...
#  gather information from the specific website: www.bankofcanada.ca/2024/01/mpr-2024-01-24/
...
url = "https://www.bankofcanada.ca/2024/01/mpr-2024-01-24/"
...
if response.status_code == 200:
    ...
    # You can modify this to extract specific elements based on your needs
    print(soup.get_text())
else:
...
# This might need adjustment to target specific parts of the page
...
user_input = st.text_input("Streamlit test")
...
# Import your Cohere Langchain model
from langchain.llms import Cohere
...
query = "what is the current unemployemnt rate in Canada?"
...
if st.button('Search'):
    if query:
        # Use your model to search the documents
        results = model.search_documents(query)
...
get_ipython().system('streamlit run C:\\Users\\yulia\\anaconda3\\Lib\\site-packages\\ipykernel_launcher.py')
